define("tableinfo", ["require", "exports"], function (require, exports) {
    "use strict";
...
define("dbutil", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("query", ["require", "exports", "dbutil"], function (require, exports, dbutil_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("dbqueue", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("db", ["require", "exports", "tableinfo", "dbutil", "query", "dbqueue"], function (require, exports, tableinfo_1, dbutil_2, query_1, dbqueue_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var db = /** @class */ (function () {
                ...
                if (err) {
                    ...
                    result.forEach(function (ele) {
                        ...
                        s._add(s._0, s, s.q._sql, a2, function (e1, r1) {
                            t--;
                            if (!dbutil_2.dbutil.isKeyPRI(r1[0])) {
        ...
        db.prototype.update = function (cb, d) {
            if (d.__1 == dbutil_2.dbutil.SELECT) {
                var s = this;
                d.__1 = dbutil_2.dbutil.UPDATE;
        ...
        db.prototype.insert = function (cb, d) {
            if (d.__1 == dbutil_2.dbutil.INIT) {
                d.__1 = dbutil_2.dbutil.INSERT;
                var s = this;
        ...
        db.prototype.delete = function (cb, d) {
            var _1 = d.__1;
            if (_1 == dbutil_2.dbutil.INIT)
                return false;
            if (_1 == dbutil_2.dbutil.INSERT) {
                d.__1 = dbutil_2.dbutil.INIT;
            }
            else if (_1 != dbutil_2.dbutil.DELETE) {
                var s = this;
                d.__1 = dbutil_2.dbutil.DELETE;
